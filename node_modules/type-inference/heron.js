"use strict";
// The Heron Programming language v1.0
// A fully type-inferred functional programming language
Object.defineProperty(exports, "__esModule", { value: true });
var HeronLanguage;
(function (HeronLanguage) {
    function CreateHeronGrammar(myna) {
        ...
        var g = new function () {
            ...
            function guardedWsDelimSeq() {
                ...
                var args = Array.prototype.slice.call(xs, 1).map(function (r) { return m.seq(m.assert(r), _this.ws); });
                return m.seq(xs[0], _this.ws, m.seq.apply(m, args));
            }
            ...
            this.statement = m.choice(this.emptyStatemnt, this.compoundStatement, this.ifStatement, this.returnStatement, this.continueStatement, this.breakStatement, this.forLoop, this.doLoop, this.whileLoop, this.varDecl, this.exprStatement).ast;
            // Global declarations 
            ...
            this.structDef = guardedWsDelimSeq(m.keyword("struct"), this.structTypeName, "{", this.structMembers, "}", this.structVarName.opt, this.varArraySizeDecl.opt, this.eos).ast;
...
})(HeronLanguage = exports.HeronLanguage || (exports.HeronLanguage = {}));
/*
...
arrayN(T N) = ('T ([] (N ('_))))
fun(T R) = (('T '_) -> ('R '_))
fun2(T U R) = (('T ('U _)) -> ('R '_))
pred(T) = ((T '_) -> (bool _S))

map : (array(T) fun2(T int U) -> array(U))
filter : (array(T) pred(T) -> array(T))
reduce : (array(T) U fun2(T U U) -> U)
